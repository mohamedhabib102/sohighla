...
export const metadata = {
  title: "إدخال رمز التحقق | شُغلَة",
  description: "أدخل رمز التحقق المكون من 4 أرقام لتفعيل حسابك بالمنصة",
};
  ...
  return (
    <main className="min-h-screen w-full bg-slate-50 flex items-center justify-center p-4 relative overflow-hidden bg-linear-to-tr from-slate-100 via-white to-orange-50/30">
      ...
      <div className="relative z-10 w-full flex justify-center">
        {/* Wrapping in Suspense because of useSearchParams() usage inside VerifyCodeForm */}
        <Suspense fallback={
