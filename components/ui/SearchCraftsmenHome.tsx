    ...
    return (
        <div className="w-full">
            <div className="bg-white rounded-2xl md:rounded-full shadow-[0_20px_50px_rgba(0,0,0,0.15)] p-1.5 md:p-2 flex flex-col md:flex-row items-center gap-1 md:gap-2 border border-white/20 backdrop-blur-sm">
                ...
                {/* Search Button */}
                <button className="w-full md:w-auto bg-linear-main text-white px-8 md:px-10 py-3 md:py-4 rounded-xl md:rounded-full font-bold flex items-center justify-center gap-2 md:gap-3 hover:shadow-xl hover:shadow-primary/30 transition-all active:scale-95 shrink-0 group">
